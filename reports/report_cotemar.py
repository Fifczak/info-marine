...
def set_col_widths_results(table):
    widths = (Cm(2.5), Cm(2), Cm(2), Cm(2), Cm(2), Cm(2), Cm(2), Cm(2))
...
def resulttable ( tn , host , username , password , tableno , id1 , id2 , rn ):
	...
	tableno.cell(0,0).alignment=WD_ALIGN_PARAGRAPH.CENTER
	tableno.cell(0,0).paragraphs[0].style=document.styles['texBtt1']
	tableno.cell(0,0).paragraphs[0].add_run('Thruster: ' +str(tn+1))
	tableno.cell(0,0).paragraphs[0].runs[0].add_break()
	
	tableno.cell(0,0).paragraphs[0].add_run('Load: ' )
	tableno.cell(0,0).paragraphs[0].runs[1].add_break()
	tableno.cell(0,0).paragraphs[0].add_run('RPM: ' )
	tableno.cell(0,0).paragraphs[0].runs[2].add_break()
	tableno.cell(0,0).paragraphs[0].add_run('RHs: ' )
	
	tableno.cell(0,1).paragraphs[0].style=document.styles['texBtt1']
	tableno.cell(0,1).paragraphs[0].alignment=WD_ALIGN_PARAGRAPH.CENTER
	...
	tableno.cell(0,6).vertical_alignment=WD_ALIGN_VERTICAL.CENTER
	tableno.cell(0,6).paragraphs[0].alignment=WD_ALIGN_PARAGRAPH.CENTER
	tableno.cell ( 0 , 6 ).paragraphs[0].style=document.styles['texBtt1']
	
	tableno.cell(0,6).paragraphs[0].add_run('Gear Part')
	tableno.cell ( 0 , 6 ).merge ( tableno.cell ( 0 , 7 ).merge ( tableno.cell ( 0 , 8 ) ) )
	tableno.cell(1,0).paragraphs[0].style=document.styles['texBtt1']
	tableno.cell(1,1).vertical_alignment=WD_ALIGN_VERTICAL.CENTER
	tableno.cell(1,1).paragraphs[0].alignment=WD_ALIGN_PARAGRAPH.LEFT 
	tableno.cell(1,0).vertical_alignment=WD_ALIGN_VERTICAL.CENTER
	tableno.cell ( 1 , 0 ).paragraphs[0].add_run ( 'Position of accelerometers').bold=False
	tableno.rows [ 1 ].cells [ 0 ]._tc.get_or_add_tcPr ().append ( shading_elm_1 )



	tableno.cell(1,1).paragraphs[0].style=document.styles['textt1']
	tableno.cell(1,1).paragraphs[0].add_run('Mot Sup')
	tableno.cell(1,1).paragraphs[0].runs[0].add_break()
	
	tableno.cell(1,1).paragraphs[0].add_run('Proa')
	tableno.cell(1,1).paragraphs[0].runs[1].add_break()
	tableno.cell(1,1).paragraphs[0].add_run('H1')
	tableno.rows [ 1 ].cells [ 1 ]._tc.get_or_add_tcPr ().append ( shading_elm_2 )
	tableno.cell(1,1).vertical_alignment=WD_ALIGN_VERTICAL.CENTER
	tableno.cell(1,1).paragraphs[0].alignment=WD_ALIGN_PARAGRAPH.CENTER
	...
	tableno.cell(1,2).paragraphs[0].style=document.styles['textt1']
	tableno.cell(1,2).paragraphs[0].add_run('Mot Sup')
	tableno.cell(1,2).paragraphs[0].runs[0].add_break()
	tableno.cell(1,2).paragraphs[0].add_run('Babor')
	tableno.cell(1,2).paragraphs[0].runs[1].add_break()
	tableno.cell(1,2).paragraphs[0].add_run('HH1')
	tableno.cell(1,2).vertical_alignment=WD_ALIGN_VERTICAL.CENTER
	tableno.cell(1,2).paragraphs[0].alignment=WD_ALIGN_PARAGRAPH.CENTER
	...
	tableno.cell(1,3).paragraphs[0].style=document.styles['textt1']
	tableno.cell(1,3).paragraphs[0].add_run('Mot Sup')
	tableno.cell(1,3).paragraphs[0].runs[0].add_break()
	tableno.cell(1,3).paragraphs[0].add_run('Proa')
	tableno.cell(1,3).paragraphs[0].runs[1].add_break()
	tableno.cell(1,3).paragraphs[0].add_run('H2')
	tableno.cell(1,3).vertical_alignment=WD_ALIGN_VERTICAL.CENTER
	tableno.cell(1,3).paragraphs[0].alignment=WD_ALIGN_PARAGRAPH.CENTER
	...
	tableno.cell(1,4).paragraphs[0].style=document.styles['textt1']
	tableno.cell(1,4).paragraphs[0].add_run('Mot Sup')
	tableno.cell(1,4).paragraphs[0].runs[0].add_break()
	tableno.cell(1,4).paragraphs[0].add_run('Babor')
	tableno.cell(1,4).paragraphs[0].runs[1].add_break()	
	tableno.cell(1,4).paragraphs[0].add_run('HH2')
	tableno.cell(1,4).paragraphs[0].alignment=WD_ALIGN_PARAGRAPH.CENTER
	...
	tableno.cell(1,5).paragraphs[0].style=document.styles['textt1']
	tableno.cell(1,5).paragraphs[0].add_run('Mot Sup')
	tableno.cell(1,5).paragraphs[0].runs[0].add_break()
	tableno.cell(1,5).paragraphs[0].add_run('Ver')
	tableno.cell(1,5).paragraphs[0].runs[1].add_break()
	tableno.cell(1,5).paragraphs[0].add_run('V2')
	tableno.cell(1,5).paragraphs[0].alignment=WD_ALIGN_PARAGRAPH.CENTER
	...
	tableno.cell(1,6).paragraphs[0].style=document.styles['textt1']
	tableno.cell(1,6).paragraphs[0].add_run('Thruster')
	tableno.cell(1,6).paragraphs[0].runs[0].add_break()
	tableno.cell(1,6).paragraphs[0].add_run('Proa')
	tableno.cell(1,6).paragraphs[0].runs[1].add_break()
	tableno.cell(1,6).paragraphs[0].add_run('H3')
	tableno.cell(1,6).paragraphs[0].alignment=WD_ALIGN_PARAGRAPH.CENTER
	...
	tableno.cell(1,7).paragraphs[0].style=document.styles['textt1']

	tableno.cell(1,7).paragraphs[0].add_run('Thruster')
	tableno.cell(1,7).paragraphs[0].runs[0].add_break()
	tableno.cell(1,7).paragraphs[0].add_run('Proa')
	tableno.cell(1,7).paragraphs[0].runs[1].add_break()
	tableno.cell(1,7).paragraphs[0].add_run('HH3')
	tableno.cell(1,7).paragraphs[0].alignment=WD_ALIGN_PARAGRAPH.CENTER
	...
	tableno.cell(1,8).paragraphs[0].style=document.styles['textt1']
	tableno.cell(1,8).paragraphs[0].add_run('Thruster')
	tableno.cell(1,8).paragraphs[0].runs[0].add_break()
	tableno.cell(1,8).paragraphs[0].add_run('Ver')
	tableno.cell(1,8).paragraphs[0].runs[1].add_break()
	tableno.cell ( 1 , 8 ).paragraphs[0].add_run('V3')
	tableno.cell(1,8).paragraphs[0].alignment=WD_ALIGN_PARAGRAPH.CENTER
	...
	for j in range ( 3 ):
		...
		r.font.name = 'Calibri'
		r.font.size = Pt ( 11 )
		set_col_widths_results(tableno)
	...
	tableno.cell(2,0).paragraphs[0].style=document.styles['textt1']
	tableno.cell(2,0).paragraphs[0].add_run('Overall velocity RMS (mm/s)')
	#tableno.cell ( 2 , 0 ).add_paragraph ( 'Overall velocity RMS (mm/s)' , 'textt1' )
	tableno.cell(2,0).vertical_alignment=WD_ALIGN_VERTICAL.CENTER
	tableno.cell(2,0).paragraphs[0].alignment=WD_ALIGN_PARAGRAPH.LEFT
	tableno.rows [ 2 ].cells [ 0 ]._tc.get_or_add_tcPr ().append ( shading_elm_10 )
	tableno.cell(3,0).paragraphs[0].style=document.styles['textt1']
...
def makereport ( username , password , host , rn_ , id_ ):  # AUTORUN!
	...
	limittablelegend.cell ( 0 , 0 ).paragraphs [ 0 ].runs[0].font.name='Calibri'
	
	limittablelegend.cell ( 0 , 1 ).paragraphs [ 0 ].add_run ( 'Newly commissioned' ).font.name='Calibri'
	#limittablelegend.cell ( 0 , 1 ).paragraphs [ 0 ].runs[0]

	limittablelegend.cell ( 1 , 0 ).paragraphs [ 0 ].add_run ('Z. B').font.highlight_color = WD_COLOR_INDEX.BRIGHT_GREEN
	limittablelegend.cell ( 1 , 0 ).paragraphs [ 0 ].runs[0].font.name='Calibri'
	
	limittablelegend.cell ( 1 , 1 ).paragraphs [ 0 ].add_run ( 'Unrestricted' ).font.name='Calibri'
	#limittablelegend.cell ( 1 , 1 ).paragraphs [ 0 ].runs[0].font.name='Calibri'

	limittablelegend.cell ( 2 , 0 ).paragraphs [ 0 ].add_run ( 'Z. C' ).font.highlight_color = WD_COLOR_INDEX.YELLOW
	limittablelegend.cell ( 2 , 0 ).paragraphs [ 0 ].runs[0].font.name='Calibri'
	limittablelegend.cell ( 2 , 1 ).paragraphs [ 0 ].add_run ( 'Restricted long-term operation' ).font.name='Calibri'
	#limittablelegend.cell ( 2 , 1 ).paragraphs [ 0 ].runs[0].font.name='Calibri'

	limittablelegend.cell ( 3 , 0 ).paragraphs [ 0 ].add_run ( 'Z. D' ).font.highlight_color = WD_COLOR_INDEX.RED
	limittablelegend.cell ( 3 , 0 ).paragraphs [ 0 ].runs[0].font.name='Calibri'
	
	limittablelegend.cell ( 3 , 1 ).paragraphs [ 0 ].add_run ( 'High probability of damage, action required' ).font.name='Calibri'
	#limittablelegend.cell ( 3 , 1 ).paragraphs [ 0 ].runs[0].font.name='Calibri'

	limittablelegend.cell ( 4 , 0 ).paragraphs [ 0 ].add_run ( 'Z. D' ).font.bold = True
	limittablelegend.cell ( 4 , 0 ).paragraphs [ 0 ].runs[0].font.name='Calibri'
	limittablelegend.cell ( 4 , 1 ).paragraphs [ 0 ].add_run ('Vibrations over the limits but actions are not required.' ).font.name='Calibri'
	#limittablelegend.cell ( 2 , 0 ).paragraphs [ 0 ].runs[0].font.name='Calibri'
...
#makereport ( 'testuser' ,'info' ,'192.168.10.243' ,'2140-2019' ,'55' )
